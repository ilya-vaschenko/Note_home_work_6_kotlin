...
public class NoteListFragment extends Fragment {
    ...
    public void createNote() {
        notes = new ArrayList<>();
        notes.add(new Note("Список важных дел", "26.07.2021", "Поспать уже наконец так, чтоб выспаться!"));
        notes.add(new Note("Список не очень важных дел", "26.07.2021", "Иди на улицу, там ЛЕТО"));
        notes.add(new Note("Список не важных дел", "26.07.2021", "Что бы ты не делал! лучше не будет! Будет по другому... "));
    }
